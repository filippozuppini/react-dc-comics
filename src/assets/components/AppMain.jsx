    ...
    return (
        <>
            ...
            <div className="sub_content">
                <div className="items"><img src={ImgDigitalComics} />DIGITAL COMICS</div>
                <div className="items"><img src={ImgMerchandise} />DC MERCHANDISE</div>
                <div className="items"><img src={ImgSubscription} />SUBSCRIPTION</div>
                <div className="items"><img src={ImgShopLocator} />COMIC SHOP LOCATOR</div>
                <div className="items"><img src={ImgPowerVisa} />DC POWER VISA</div>
